...
- Open an [Issue](https://github.com/horstoeko/zugferd/issues/new).
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in the [bug tracker](https://github.com/horstoeko/zugferdissues?q=label%3Abug).
...
- Open an [Issue](https://github.com/horstoeko/zugferd/issues/new). (Since we can't be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label the issue.)
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/horstoeko/zugferd/issues).
