...
class TradeTaxType
{
    ...
    /**
     * @var \horstoeko\zugferd\basicwl\udt\AmountType $calculatedAmount
     */
     ...
     *
     * @param \horstoeko\zugferd\basicwl\udt\AmountType $calculatedAmount
     * @return self
     */
    public function setCalculatedAmount(\horstoeko\zugferd\basicwl\udt\AmountType $calculatedAmount)
    {
