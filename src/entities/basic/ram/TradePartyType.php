...
class TradePartyType
{
    ...
    /**
     * @var \horstoeko\zugferd\basic\ram\LegalOrganizationType $specifiedLegalOrganization
     */
    private $specifiedLegalOrganization = null;

    /**
     * @var \horstoeko\zugferd\basic\ram\TradeAddressType $postalTradeAddress
     */
    private $postalTradeAddress = null;

    /**
     * @var \horstoeko\zugferd\basic\ram\UniversalCommunicationType $uRIUniversalCommunication
     */
    private $uRIUniversalCommunication = null;

    /**
     * @var \horstoeko\zugferd\basic\ram\TaxRegistrationType[] $specifiedTaxRegistration
     */
     ...
     */
    public function addToID(\horstoeko\zugferd\basic\udt\IDType $iD)
    {
        $this->iD[] = $iD;
        return $this;
    }
     ...
     */
    public function addToGlobalID(\horstoeko\zugferd\basic\udt\IDType $globalID)
    {
     ...
     *
     * @return \horstoeko\zugferd\basic\ram\LegalOrganizationType
     */
     ...
     *
     * @param \horstoeko\zugferd\basic\ram\LegalOrganizationType $specifiedLegalOrganization
     * @return self
     */
    public function setSpecifiedLegalOrganization(\horstoeko\zugferd\basic\ram\LegalOrganizationType $specifiedLegalOrganization)
    {
     ...
     *
     * @return \horstoeko\zugferd\basic\ram\TradeAddressType
     */
     ...
     *
     * @param \horstoeko\zugferd\basic\ram\TradeAddressType $postalTradeAddress
     * @return self
     */
    public function setPostalTradeAddress(\horstoeko\zugferd\basic\ram\TradeAddressType $postalTradeAddress)
    {
     ...
     *
     * @return \horstoeko\zugferd\basic\ram\UniversalCommunicationType
     */
     ...
     *
     * @param \horstoeko\zugferd\basic\ram\UniversalCommunicationType $uRIUniversalCommunication
     * @return self
     */
    public function setURIUniversalCommunication(\horstoeko\zugferd\basic\ram\UniversalCommunicationType $uRIUniversalCommunication)
    {
     ...
     *
     * @return self
     * @param \horstoeko\zugferd\basic\ram\TaxRegistrationType $specifiedTaxRegistration
     */
    public function addToSpecifiedTaxRegistration(\horstoeko\zugferd\basic\ram\TaxRegistrationType $specifiedTaxRegistration)
    {
     ...
     *
     * @return \horstoeko\zugferd\basic\ram\TaxRegistrationType[]
     */
