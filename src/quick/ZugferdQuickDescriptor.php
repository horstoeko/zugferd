...
class ZugferdQuickDescriptor extends ZugferdDocumentBuilder
{
    ...
    {
        return self::createNew(self::getProfile());
    }
    ...
    {
        $this->addDocumentPaymentMean(false === $isSEPA ? ZugferdPaymentMeans::UNTDID_4461_31 : ZugferdPaymentMeans::UNTDID_4461_59, null, null, null, null, $buyerIban);
    ...
    {
        $this->addDocumentPaymentMean(false === $isSEPA ? ZugferdPaymentMeans::UNTDID_4461_30 : ZugferdPaymentMeans::UNTDID_4461_58, null, null, null, null, null, $payeeIban, $payeeAccountName, $payeePropId, $payeeBic);
