...
class ZugferdDocumentBuilder extends ZugferdDocument
{
     ...
     */
    public static function createNew(int $profileId): self
    {
     ...
     */
    public function setDocumentInformation(string $documentNo, string $documentTypeCode, DateTimeInterface $documentDate, string $invoiceCurrency, ?string $documentName = null, ?string $documentLanguage = null, ?DateTimeInterface $effectiveSpecifiedPeriod = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentGeneralPaymentInformation(?string $creditorReferenceID = null, ?string $paymentReference = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentBuyerReference(?string $buyerReference): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentRoutingId(string $routingId): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentBusinessProcess(string $id): self
    {
        if (ZugferdObjectHelper::isNullOrEmpty($id)) {
            return $this;
        }
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setIsDocumentCopy(): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setIsTestDocument(): self
    {
     ...
     */
    public function setForeignCurrency(string $foreignCurrencyCode, float $foreignTaxAmount, ?float $exchangeRate = null): self
    {
        ...
        foreach ($taxTotalAmounts as $taxTotalAmount) {
            if ((string) $this->getObjectHelper()->tryCallAndReturn($taxTotalAmount, 'getCurrencyID') === (string) $invoiceCurrencyCode) {
                $taxTotalAmountInvoice = $taxTotalAmount;
            }

            if ((string) $this->getObjectHelper()->tryCallAndReturn($taxTotalAmount, 'getCurrencyID') === $foreignCurrencyCode) {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentNote(string $content, ?string $contentCode = null, ?string $subjectCode = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentSeller(string $name, ?string $id = null, ?string $description = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentSellerId(string $id): self
    {
     ...
     * @param  null|string            $globalIDType __BT-29-1, From BASIC WL__ If the identifier is used for the identification scheme, it must be selected from the entries in the list published by the ISO / IEC 6523 Maintenance Agency
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentSellerGlobalId(?string $globalID = null, ?string $globalIDType = null): self
    {
        $sellerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getSellerTradeParty');
     ...
     *
     * @param  null|string            $taxRegType __BT-31-0/BT-32-0, From MINIMUM/EN 16931__ Type of tax number of the seller (FC = Tax number, VA = Sales tax identification number)
     * @param  null|string            $taxRegId   __BT-31/32, From MINIMUM/EN 16931__ Tax number of the seller or sales tax identification number of the seller
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentSellerTaxRegistration(?string $taxRegType = null, ?string $taxRegId = null): self
    {
        $sellerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getSellerTradeParty');
     ...
     *
     * @param  null|string            $vatRegNo __BT-31, From MINIMUM/EN 16931__ VAT Registration Number (Umsatzsteueridentnummer)
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentSellerVATRegistrationNumber(?string $vatRegNo = null): self
    {
     ...
     *
     * @param  null|string            $taxNo __BT-32, From MINIMUM/EN 16931__ Tax Number (Steuernummer)
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentSellerTaxNumber(?string $taxNo = null): self
    {
     ...
     * @param  null|string            $subDivision __BT-39, From BASIC WL__ The sellers state
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentSellerAddress(?string $lineOne = null, ?string $lineTwo = null, ?string $lineThree = null, ?string $postCode = null, ?string $city = null, ?string $country = null, ?string $subDivision = null): self
    {
        $sellerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getSellerTradeParty');
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentSellerLegalOrganisation(?string $legalOrgId, ?string $legalOrgType, ?string $legalOrgName): self
    {
        $sellerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getSellerTradeParty');
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentSellerContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $sellerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getSellerTradeParty');
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentSellerContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $sellerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getSellerTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentSellerCommunication(?string $uriScheme, ?string $uri): self
    {
        $sellerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getSellerTradeParty');
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentBuyer(string $name, ?string $id = null, ?string $description = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentBuyerId(string $id): self
    {
     ...
     * @param  null|string            $globalIDType __BT-46-1, From BASIC WL__ If the identifier is used for the identification scheme, it must be selected from the entries in the list published by the ISO / IEC 6523 Maintenance Agency
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentBuyerGlobalId(?string $globalID = null, ?string $globalIDType = null): self
    {
        $buyerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getBuyerTradeParty');
     ...
     * identification number, unless he uses a tax agent.
     *
     * @param  null|string            $taxRegType __BT-48-0, From BASIC WL__ Type of tax number (FC = Tax number, VA = Sales tax identification number)
     * @param  null|string            $taxRegId   __BT-48, From BASIC WL__ Tax number or sales tax identification number
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentBuyerTaxRegistration(?string $taxRegType = null, ?string $taxRegId = null): self
    {
        $buyerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getBuyerTradeParty');
        $taxReg = $this->getObjectHelper()->getTaxRegistrationType($taxRegType, $taxRegId);
     ...
     *
     * @param  null|string            $vatRegNo __BT-48, From MINIMUM/EN 16931__ VAT Registration Number (Umsatzsteueridentnummer)
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentBuyerVATRegistrationNumber(?string $vatRegNo = null): self
    {
     ...
     *
     * @param  null|string            $taxNo __BT-48, From MINIMUM/EN 16931__ Tax Number (Steuernummer)
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentBuyerTaxNumber(?string $taxNo = null): self
    {
     ...
     * @param  null|string            $subDivision __BT-54, From BASIC WL__ The buyers state
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentBuyerAddress(?string $lineOne = null, ?string $lineTwo = null, ?string $lineThree = null, ?string $postCode = null, ?string $city = null, ?string $country = null, ?string $subDivision = null): self
    {
        $buyerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getBuyerTradeParty');
        $address = $this->getObjectHelper()->getTradeAddress($lineOne, $lineTwo, $lineThree, $postCode, $city, $country, $subDivision);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentBuyerLegalOrganisation(?string $legalOrgId, ?string $legalOrgType, ?string $legalOrgName): self
    {
        $buyerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getBuyerTradeParty');
        $legalOrg = $this->getObjectHelper()->getLegalOrganization($legalOrgId, $legalOrgType, $legalOrgName);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentBuyerContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $buyerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getBuyerTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentBuyerContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $buyerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getBuyerTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentBuyerCommunication(?string $uriScheme, ?string $uri): self
    {
        $buyerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getBuyerTradeParty');
        $communication = $this->getObjectHelper()->getUniversalCommunicationType(null, $uri, $uriScheme);
     ...
     * @param  null|string            $id          __BT-X-116, From EXTENDED__ An identifier of the sellers tax agent
     * @param  null|string            $description __BT-, From __ Further legal information that is relevant for the sellers tax agent
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentSellerTaxRepresentativeTradeParty(string $name, ?string $id = null, ?string $description = null): self
    {
     ...
     *
     * @param  null|string            $globalID     __BT-X-117, From EXTENDED__ The seller's tax agent identifier identification scheme is an identifier uniquely assigned to a seller by a global registration organization
     * @param  null|string            $globalIDType __BT-X-117-1, From EXTENDED__ If the identifier is used for the identification scheme, it must be selected from the entries in the list published by the ISO / IEC 6523 Maintenance Agency
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentSellerTaxRepresentativeGlobalId(?string $globalID = null, ?string $globalIDType = null): self
    {
     ...
     *
     * @param  null|string            $taxRegType __BT-63-0, From BASIC WL__ Type of tax number (FC = Tax number, VA = Sales tax identification number)
     * @param  null|string            $taxRegId   __BT-63, From BASIC WL__ Tax number or sales tax identification number
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentSellerTaxRepresentativeTaxRegistration(?string $taxRegType = null, ?string $taxRegId = null): self
    {
        $taxrepresentativeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getSellerTaxRepresentativeTradeParty');
        $taxReg = $this->getObjectHelper()->getTaxRegistrationType($taxRegType, $taxRegId);
     ...
     * @param  null|string            $subDivision __BT-68, From BASIC WL__ The sellers tax agent state
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentSellerTaxRepresentativeAddress(?string $lineOne = null, ?string $lineTwo = null, ?string $lineThree = null, ?string $postCode = null, ?string $city = null, ?string $country = null, ?string $subDivision = null): self
    {
        $taxrepresentativeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getSellerTaxRepresentativeTradeParty');
        $address = $this->getObjectHelper()->getTradeAddress($lineOne, $lineTwo, $lineThree, $postCode, $city, $country, $subDivision);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentSellerTaxRepresentativeLegalOrganisation(?string $legalOrgId, ?string $legalOrgType, ?string $legalOrgName): self
    {
        $taxrepresentativeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getSellerTaxRepresentativeTradeParty');
        $legalOrg = $this->getObjectHelper()->getLegalOrganization($legalOrgId, $legalOrgType, $legalOrgName);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentSellerTaxRepresentativeContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $taxrepresentativeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getSellerTaxRepresentativeTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentSellerTaxRepresentativeContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $taxrepresentativeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getSellerTaxRepresentativeTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @param  null|string            $id          __BT-X-364, From EXTENDED__ An identifier of the buyer's tax representative
     * @param  null|string            $description __BT-, From __ Further legal information that is relevant for the buyer's tax representative
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentBuyerTaxRepresentativeTradeParty(string $name, ?string $id = null, ?string $description = null): self
    {
     ...
     *
     * @param  null|string            $globalID     __BT-X-365, From EXTENDED__ The buyer's tax representative identifier identification scheme is an identifier uniquely assigned to a party by a global registration organization
     * @param  null|string            $globalIDType __BT-X-365-0, From EXTENDED__ If the identifier is used for the identification scheme, it must be selected from the entries in the list published by the ISO / IEC 6523 Maintenance Agency
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentBuyerTaxRepresentativeGlobalId(?string $globalID = null, ?string $globalIDType = null): self
    {
     ...
     *
     * @param  null|string            $taxRegType __BT-X-367-0, From EXTENDED__ Type of tax number (FC = Tax number, VA = Sales tax identification number)
     * @param  null|string            $taxRegId   __BT-X-367, From EXTENDED__ Tax number or sales tax identification number
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentBuyerTaxRepresentativeTaxRegistration(?string $taxRegType = null, ?string $taxRegId = null): self
    {
        $taxrepresentativeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getBuyerTaxRepresentativeTradeParty');
        $taxReg = $this->getObjectHelper()->getTaxRegistrationType($taxRegType, $taxRegId);
     ...
     * @param  null|string            $subDivision __BT-X-388, From EXTENDED__ The buyer's tax representative state
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentBuyerTaxRepresentativeAddress(?string $lineOne = null, ?string $lineTwo = null, ?string $lineThree = null, ?string $postCode = null, ?string $city = null, ?string $country = null, ?string $subDivision = null): self
    {
        $taxrepresentativeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getBuyerTaxRepresentativeTradeParty');
        $address = $this->getObjectHelper()->getTradeAddress($lineOne, $lineTwo, $lineThree, $postCode, $city, $country, $subDivision);
     ...
     *
     * @param  null|string            $legalOrgId   __BT-, From __ An identifier issued by an official registrar that identifies the buyer's tax representative as a legal entity or legal person
     * @param  null|string            $legalOrgType __BT-, From __ The identifier for the identification scheme of the legal registration of the buyer's tax representative. If the identification scheme is used, it must be selected from ISO/IEC 6523 list
     * @param  null|string            $legalOrgName __BT-, From __ A name by which the buyer's tax representative is known, if different from the buyer's tax representative name (also known as the company name)
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentBuyerTaxRepresentativeLegalOrganisation(?string $legalOrgId, ?string $legalOrgType, ?string $legalOrgName): self
    {
        $taxrepresentativeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getBuyerTaxRepresentativeTradeParty');
        $legalOrg = $this->getObjectHelper()->getLegalOrganization($legalOrgId, $legalOrgType, $legalOrgName);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentBuyerTaxRepresentativeContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $taxrepresentativeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getBuyerTaxRepresentativeTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentBuyerTaxRepresentativeContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $taxrepresentativeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getBuyerTaxRepresentativeTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @param  null|string            $id          __BT-X-126, From EXTENDED__ An identifier of the product end user
     * @param  null|string            $description __BT-, From __ Further legal information that is relevant for the product end user
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentProductEndUser(string $name, ?string $id = null, ?string $description = null): self
    {
     ...
     *
     * @param  null|string            $globalID     __BT-X-127, From EXTENDED__ The identifier is uniquely assigned to a party by a global registration organization
     * @param  null|string            $globalIDType __BT-X-127-0, From EXTENDED__ If the identifier is used for the identification scheme, it must be selected from the entries in the list published by the ISO / IEC 6523 Maintenance Agency
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentProductEndUserGlobalId(?string $globalID = null, ?string $globalIDType = null): self
    {
     ...
     *
     * @param  null|string            $taxRegType __BT-, From __ Type of tax number (FC = Tax number, VA = Sales tax identification number)
     * @param  null|string            $taxRegId   __BT-, From __ Tax number or sales tax identification number
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentProductEndUserTaxRegistration(?string $taxRegType = null, ?string $taxRegId = null): self
    {
        $productEndUserTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getProductEndUserTradeParty');
        $taxReg = $this->getObjectHelper()->getTaxRegistrationType($taxRegType, $taxRegId);
     ...
     * @param  null|string            $subDivision __BT-X-402, From EXTENDED__ The product end users state
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentProductEndUserAddress(?string $lineOne = null, ?string $lineTwo = null, ?string $lineThree = null, ?string $postCode = null, ?string $city = null, ?string $country = null, ?string $subDivision = null): self
    {
        $productEndUserTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getProductEndUserTradeParty');
        $address = $this->getObjectHelper()->getTradeAddress($lineOne, $lineTwo, $lineThree, $postCode, $city, $country, $subDivision);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentProductEndUserLegalOrganisation(?string $legalOrgId, ?string $legalOrgType, ?string $legalOrgName): self
    {
        $productEndUserTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getProductEndUserTradeParty');
        $legalOrg = $this->getObjectHelper()->getLegalOrganization($legalOrgId, $legalOrgType, $legalOrgName);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentProductEndUserContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $productEndUserTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getProductEndUserTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentProductEndUserContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $productEndUserTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeAgreement, 'getProductEndUserTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentShipTo(?string $name = null, ?string $id = null, ?string $description = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentShipTolId(string $id): self
    {
     ...
     *
     * @param  null|string            $globalID     __BT-71-0, From BASIC WL__ Global identifier of the goods recipient
     * @param  null|string            $globalIDType __BT-71-1, From BASIC WL__ Type of global identification number, must be selected from the entries in the list published by the ISO / IEC 6523 Maintenance Agency
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentShipToGlobalId(?string $globalID = null, ?string $globalIDType = null): self
    {
        $shipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getShipToTradeParty');
     ...
     *
     * @param  null|string            $taxRegType __BT-X-161-0, From EXTENDED__ Type of tax number (FC = Tax number, VA = Sales tax identification number)
     * @param  null|string            $taxRegId   __BT-X-161, From EXTENDED__ Tax number or sales tax identification number
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentShipToTaxRegistration(?string $taxRegType = null, ?string $taxRegId = null): self
    {
        $shipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getShipToTradeParty');
        $taxReg = $this->getObjectHelper()->getTaxRegistrationType($taxRegType, $taxRegId);
     ...
     * @param  null|string            $subDivision __BT-79, From BASIC WL__ The party's state
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentShipToAddress(?string $lineOne = null, ?string $lineTwo = null, ?string $lineThree = null, ?string $postCode = null, ?string $city = null, ?string $country = null, ?string $subDivision = null): self
    {
        $shipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getShipToTradeParty');
        $address = $this->getObjectHelper()->getTradeAddress($lineOne, $lineTwo, $lineThree, $postCode, $city, $country, $subDivision);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentShipToLegalOrganisation(?string $legalOrgId, ?string $legalOrgType, ?string $legalOrgName): self
    {
        $shipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getShipToTradeParty');
        $legalOrg = $this->getObjectHelper()->getLegalOrganization($legalOrgId, $legalOrgType, $legalOrgName);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentShipToContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $shipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getShipToTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentShipToContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $shipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getShipToTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @param  null|string            $id          __BT-X-162, From EXTENDED__ Identification of the different end recipient. Multiple IDs can be assigned or specified. They can be differentiated by using different identification schemes.
     * @param  null|string            $description __BT-, From __ Further legal information that is relevant for the different end recipient
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentUltimateShipTo(?string $name = null, ?string $id = null, ?string $description = null): self
    {
        $shipToTradeParty = $this->getObjectHelper()->getTradePartyAllowEmpty($name, $id, $description);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentUltimateShipToId(string $id): self
    {
     ...
     *
     * @param  null|string            $globalID     __BT-X-163, From EXTENDED__ Global identifier of the different end recipient
     * @param  null|string            $globalIDType __BT-X-163-0, From EXTENDED__ Type of global identification number, must be selected from the entries in the list published by the ISO / IEC 6523 Maintenance Agency
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentUltimateShipToGlobalId(?string $globalID = null, ?string $globalIDType = null): self
    {
        $UltimateShipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getUltimateShipToTradeParty');
     ...
     *
     * @param  null|string            $taxRegType __BT-X-180-0, From EXTENDED__ Type of tax number (FC = Tax number, VA = Sales tax identification number)
     * @param  null|string            $taxRegId   __BT-X-180, From EXTENDED__ Tax number or sales tax identification number
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentUltimateShipToTaxRegistration(?string $taxRegType = null, ?string $taxRegId = null): self
    {
        $UltimateShipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getUltimateShipToTradeParty');
        $taxReg = $this->getObjectHelper()->getTaxRegistrationType($taxRegType, $taxRegId);
     ...
     * @param  null|string            $subDivision __BT-X-178, From EXTENDED__ The party's state
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentUltimateShipToAddress(?string $lineOne = null, ?string $lineTwo = null, ?string $lineThree = null, ?string $postCode = null, ?string $city = null, ?string $country = null, ?string $subDivision = null): self
    {
        $UltimateShipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getUltimateShipToTradeParty');
        $address = $this->getObjectHelper()->getTradeAddress($lineOne, $lineTwo, $lineThree, $postCode, $city, $country, $subDivision);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentUltimateShipToLegalOrganisation(?string $legalOrgId, ?string $legalOrgType, ?string $legalOrgName): self
    {
        $UltimateShipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getUltimateShipToTradeParty');
        $legalOrg = $this->getObjectHelper()->getLegalOrganization($legalOrgId, $legalOrgType, $legalOrgName);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentUltimateShipToContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $UltimateShipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getUltimateShipToTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentUltimateShipToContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $UltimateShipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getUltimateShipToTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentShipFrom(?string $name = null, ?string $id = null, ?string $description = null): self
    {
        $shipToTradeParty = $this->getObjectHelper()->getTradePartyAllowEmpty($name, $id, $description);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentShipFromId(string $id): self
    {
     ...
     *
     * @param  null|string            $globalID     __BT-X-182, From EXTENDED__ Global identifier of the goods recipient
     * @param  null|string            $globalIDType __BT-X-182-0, From EXTENDED__ Type of global identification number, must be selected from the entries in the list published by the ISO / IEC 6523 Maintenance Agency
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentShipFromGlobalId(?string $globalID = null, ?string $globalIDType = null): self
    {
        $shipFromTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getShipFromTradeParty');
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentShipFromTaxRegistration(?string $taxRegType = null, ?string $taxRegId = null): self
    {
        $shipFromTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getShipFromTradeParty');
        $taxReg = $this->getObjectHelper()->getTaxRegistrationType($taxRegType, $taxRegId);
     ...
     * @param  null|string            $subDivision __BT-X-197, From EXTENDED__ The party's state
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentShipFromAddress(?string $lineOne = null, ?string $lineTwo = null, ?string $lineThree = null, ?string $postCode = null, ?string $city = null, ?string $country = null, ?string $subDivision = null): self
    {
        $shipFromTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getShipFromTradeParty');
        $address = $this->getObjectHelper()->getTradeAddress($lineOne, $lineTwo, $lineThree, $postCode, $city, $country, $subDivision);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentShipFromLegalOrganisation(?string $legalOrgId, ?string $legalOrgType, ?string $legalOrgName): self
    {
        $shipFromTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getShipFromTradeParty');
        $legalOrg = $this->getObjectHelper()->getLegalOrganization($legalOrgId, $legalOrgType, $legalOrgName);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentShipFromContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $shipFromTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getShipFromTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentShipFromContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $shipFromTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeDelivery, 'getShipFromTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentInvoicer(string $name, ?string $id = null, ?string $description = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentInvoicerId(string $id): self
    {
     ...
     *
     * @param  null|string            $globalID     __BT-X-206, From EXTENDED__ Global identifier of the goods recipient
     * @param  null|string            $globalIDType __BT-X-206-0, From EXTENDED__ Type of global identification number, must be selected from the entries in the list published by the ISO / IEC 6523 Maintenance Agency
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentInvoicerGlobalId(?string $globalID = null, ?string $globalIDType = null): self
    {
        $invoicerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getInvoicerTradeParty');
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentInvoicerTaxRegistration(?string $taxRegType = null, ?string $taxRegId = null): self
    {
        $invoicerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getInvoicerTradeParty');
        $taxReg = $this->getObjectHelper()->getTaxRegistrationType($taxRegType, $taxRegId);
     ...
     * @param  null|string            $subDivision __BT-X-221, From EXTENDED__ The party's state
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentInvoicerAddress(?string $lineOne = null, ?string $lineTwo = null, ?string $lineThree = null, ?string $postCode = null, ?string $city = null, ?string $country = null, ?string $subDivision = null): self
    {
        $invoicerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getInvoicerTradeParty');
        $address = $this->getObjectHelper()->getTradeAddress($lineOne, $lineTwo, $lineThree, $postCode, $city, $country, $subDivision);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentInvoicerLegalOrganisation(?string $legalOrgId, ?string $legalOrgType, ?string $legalOrgName): self
    {
        $invoicerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getInvoicerTradeParty');
        $legalOrg = $this->getObjectHelper()->getLegalOrganization($legalOrgId, $legalOrgType, $legalOrgName);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentInvoicerContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $invoicerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getInvoicerTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentInvoicerContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $invoicerTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getInvoicerTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentInvoicee(string $name, ?string $id = null, ?string $description = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentInvoiceeId(string $id): self
    {
     ...
     *
     * @param  null|string            $globalID     __BT-X-225, From EXTENDED__ Global identification number
     * @param  null|string            $globalIDType __BT-X-225-0, From EXTENDED__ Type of global identification number, must be selected from the entries in the list published by the ISO / IEC 6523 Maintenance Agency
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentInvoiceeGlobalId(?string $globalID = null, ?string $globalIDType = null): self
    {
        $invoiceeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getInvoiceeTradeParty');
     ...
     *
     * @param  null|string            $taxRegType __BT-X-242-0, From EXTENDED__ Type of tax number (FC = Tax number, VA = Sales tax identification number)
     * @param  null|string            $taxRegId   __BT-X-242, From EXTENDED__ Tax number or sales tax identification number
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentInvoiceeTaxRegistration(?string $taxRegType = null, ?string $taxRegId = null): self
    {
        $invoiceeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getInvoiceeTradeParty');
        $taxReg = $this->getObjectHelper()->getTaxRegistrationType($taxRegType, $taxRegId);
     ...
     * @param  null|string            $subDivision __BT-X-240, From EXTENDED__ The party's state
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentInvoiceeAddress(?string $lineOne = null, ?string $lineTwo = null, ?string $lineThree = null, ?string $postCode = null, ?string $city = null, ?string $country = null, ?string $subDivision = null): self
    {
        $invoiceeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getInvoiceeTradeParty');
        $address = $this->getObjectHelper()->getTradeAddress($lineOne, $lineTwo, $lineThree, $postCode, $city, $country, $subDivision);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentInvoiceeLegalOrganisation(?string $legalOrgId, ?string $legalOrgType, ?string $legalOrgName): self
    {
        $invoiceeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getInvoiceeTradeParty');
        $legalOrg = $this->getObjectHelper()->getLegalOrganization($legalOrgId, $legalOrgType, $legalOrgName);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentInvoiceeContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $invoiceeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getInvoiceeTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentInvoiceeContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $invoiceeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getInvoiceeTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPayee(string $name, ?string $id = null, ?string $description = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPayeeId(string $id): self
    {
     ...
     *
     * @param  null|string            $globalID     __BT-60-0, From BASIC WL__ Global identification number
     * @param  null|string            $globalIDType __BT-60-1, From BASIC WL__ Type of global identification number, must be selected from the entries in the list published by the ISO / IEC 6523 Maintenance Agency
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPayeeGlobalId(?string $globalID = null, ?string $globalIDType = null): self
    {
        $payeeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getPayeeTradeParty');
     ...
     *
     * @param  null|string            $taxRegType __BT-X-257-0, From EXTENDED__ Type of tax number (FC = Tax number, VA = Sales tax identification number)
     * @param  null|string            $taxRegId   __BT-X-257, From EXTENDED Tax number or sales tax identification number
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPayeeTaxRegistration(?string $taxRegType = null, ?string $taxRegId = null): self
    {
        $payeeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getPayeeTradeParty');
        $taxReg = $this->getObjectHelper()->getTaxRegistrationType($taxRegType, $taxRegId);
     ...
     * @param  null|string            $subDivision __BT-X-255, From EXTENDED__ The party's state
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPayeeAddress(?string $lineOne = null, ?string $lineTwo = null, ?string $lineThree = null, ?string $postCode = null, ?string $city = null, ?string $country = null, ?string $subDivision = null): self
    {
        $payeeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getPayeeTradeParty');
        $address = $this->getObjectHelper()->getTradeAddress($lineOne, $lineTwo, $lineThree, $postCode, $city, $country, $subDivision);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPayeeLegalOrganisation(?string $legalOrgId, ?string $legalOrgType, ?string $legalOrgName): self
    {
        $payeeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getPayeeTradeParty');
        $legalOrg = $this->getObjectHelper()->getLegalOrganization($legalOrgId, $legalOrgType, $legalOrgName);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPayeeContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $payeeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getPayeeTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPayeeContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $payeeTradeParty = $this->getObjectHelper()->tryCallAndReturn($this->headerTradeSettlement, 'getPayeeTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentDeliveryTerms(?string $code): self
    {
     ...
     */
    public function setDocumentSellerOrderReferencedDocument(string $issuerAssignedId, ?DateTimeInterface $issueDate = null): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function setDocumentBuyerOrderReferencedDocument(?string $issuerAssignedId, ?DateTimeInterface $issueDate = null): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function setDocumentQuotationReferencedDocument(?string $issuerAssignedId, ?DateTimeInterface $issueDate = null): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function setDocumentContractReferencedDocument(?string $issuerAssignedId, ?DateTimeInterface $issueDate = null): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function addDocumentAdditionalReferencedDocument(string $issuerAssignedId, string $typeCode, ?string $uriId = null, $name = null, ?string $refTypeCode = null, ?DateTimeInterface $issueDate = null, ?string $binaryDataFilename = null, ?string $base64EncodedData = null): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function addDocumentInvoiceSupportingDocumentWithUri(string $issuerAssignedId, string $uriId, $name = null): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function addDocumentInvoiceSupportingDocumentWithFile(string $issuerAssignedId, string $binaryDataFilename, $name = null): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function addDocumentTenderOrLotReferenceDocument(string $issuerAssignedId): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function addDocumentInvoicedObjectReferenceDocument(string $issuerAssignedId, string $refTypeCode): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function setDocumentInvoiceReferencedDocument(string $issuerAssignedId, ?string $typeCode = null, ?DateTimeInterface $issueDate = null): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function addDocumentInvoiceReferencedDocument(string $issuerAssignedId, ?string $typeCode = null, ?DateTimeInterface $issueDate = null): self
    {
        $invoicerefdoc = $this->getObjectHelper()->getReferencedDocumentType($issuerAssignedId, null, null, $typeCode, null, null, $issueDate, null);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentProcuringProject(string $id, string $name = 'Project Reference'): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function addDocumentUltimateCustomerOrderReferencedDocument(string $issuerAssignedId, ?DateTimeInterface $issueDate = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentSupplyChainEvent(?DateTimeInterface $date): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function setDocumentDespatchAdviceReferencedDocument(?string $issuerAssignedId, ?DateTimeInterface $issueDate = null): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function setDocumentReceivingAdviceReferencedDocument(string $issuerAssignedId, ?DateTimeInterface $issueDate = null): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function setDocumentDeliveryNoteReferencedDocument(string $issuerAssignedId, ?DateTimeInterface $issueDate = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPaymentMean(string $typeCode, ?string $information = null, ?string $cardType = null, ?string $cardId = null, ?string $cardHolderName = null, ?string $buyerIban = null, ?string $payeeIban = null, ?string $payeeAccountName = null, ?string $payeePropId = null, ?string $payeeBic = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPaymentMeanToCreditTransfer(string $payeeIban, ?string $payeeAccountName = null, ?string $payeePropId = null, ?string $payeeBic = null, ?string $paymentReference = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPaymentMeanToCreditTransferNonSepa(string $payeeIban, ?string $payeeAccountName = null, ?string $payeePropId = null, ?string $payeeBic = null, ?string $paymentReference = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPaymentMeanToDirectDebit(string $buyerIban, ?string $creditorReferenceID = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPaymentMeanToDirectDebitNonSepa(string $buyerIban, ?string $creditorReferenceID = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPaymentMeanToPaymentCard(string $cardType, string $cardId, ?string $cardHolderName = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentTaxSimple(string $categoryCode, string $typeCode, float $basisAmount, float $calculatedAmount, ?float $rateApplicablePercent = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentBillingPeriod(?DateTimeInterface $startDate, ?DateTimeInterface $endDate, ?string $description): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentLogisticsServiceCharge(string $description, float $appliedAmount, ?array $taxTypeCodes = null, ?array $taxCategoryCodes = null, ?array $rateApplicablePercents = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPaymentTerm(?string $description = null, ?DateTimeInterface $dueDate = null, ?string $directDebitMandateID = null, ?float $partialPaymentAmount = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDiscountTermsToPaymentTerms(?float $calculationPercent = null, ?DateTimeInterface $basisDateTime = null, ?float $basisPeriodMeasureValue = null, ?string $basisPeriodMeasureUnitCode = null, ?float $basisAmount = null, ?float $actualDiscountAmount = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addPenaltyTermsToPaymentTerms(?float $calculationPercent = null, ?DateTimeInterface $basisDateTime = null, ?float $basisPeriodMeasureValue = null, ?string $basisPeriodMeasureUnitCode = null, ?float $basisAmount = null, ?float $actualPenaltyAmount = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPaymentTermXRechnung(string $description, array $paymentDiscountDays = [], array $paymentDiscountPercents = [], array $paymentDiscountBaseAmounts = [], ?DateTimeInterface $dueDate = null, ?string $directDebitMandateID = null): self
    {
        $paymentTermsDescription = [];

        if (ZugferdObjectHelper::isNullOrEmpty($description)) {
            return $this;
        }
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentReceivableSpecifiedTradeAccountingAccount(string $id, ?string $typeCode = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function initDocumentSummation(): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentSummation(float $grandTotalAmount, float $duePayableAmount, ?float $lineTotalAmount = null, ?float $chargeTotalAmount = null, ?float $allowanceTotalAmount = null, ?float $taxBasisTotalAmount = null, ?float $taxTotalAmount = null, ?float $roundingAmount = null, ?float $totalPrepaidAmount = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addNewPosition(string $lineid, ?string $lineStatusCode = null, ?string $lineStatusReasonCode = null): self
    {
     ...
     * @deprecated 1.0.75
     */
    public function addNewTextPosition(string $lineid, ?string $lineStatusCode = null, ?string $lineStatusReasonCode = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionNote(?string $content, ?string $contentCode = null, ?string $subjectCode = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPositionProductCharacteristic(string $description, string $value, ?string $typeCode = null, ?float $valueMeasure = null, ?string $valueMeasureUnitCode = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPositionProductClassification(string $classCode, ?string $className = null, ?string $listId = null, ?string $listVersionId = null): self
    {
        $product = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedTradeProduct');
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPositionReferencedProduct(string $name, ?string $description = null, ?string $sellerAssignedID = null, ?string $buyerAssignedID = null, ?string $globalID = null, ?string $globalIDType = null, ?float $unitQuantity = null, ?string $unitCode = null, ?string $industryAssignedID = null): self
    {
        $product = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedTradeProduct');
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionProductOriginTradeCountry(string $country): self
    {
        $product = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedTradeProduct');
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function setDocumentPositionSellerOrderReferencedDocument(string $issuerAssignedId, string $lineId, ?DateTimeInterface $issueDate = null): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function setDocumentPositionBuyerOrderReferencedDocument(string $issuerAssignedId, string $lineId, ?DateTimeInterface $issueDate = null): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function setDocumentPositionQuotationReferencedDocument(string $issuerAssignedId, string $lineId, ?DateTimeInterface $issueDate = null): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function setDocumentPositionContractReferencedDocument(string $issuerAssignedId, string $lineId, ?DateTimeInterface $issueDate = null): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function addDocumentPositionAdditionalReferencedDocument(string $issuerAssignedId, string $typeCode, ?string $uriId = null, ?string $lineId = null, ?string $name = null, ?string $refTypeCode = null, ?DateTimeInterface $issueDate = null, ?string $binaryDataFilename = null): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function addDocumentPositionUltimateCustomerOrderReferencedDocument(string $issuerAssignedId, string $lineId, ?DateTimeInterface $issueDate = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionGrossPrice(float $amount, ?float $basisQuantity = null, ?string $basisQuantityUnitCode = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionNetPrice(float $amount, ?float $basisQuantity = null, ?string $basisQuantityUnitCode = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionNetPriceTax(string $categoryCode, string $typeCode, float $rateApplicablePercent, float $calculatedAmount, ?string $exemptionReason = null, ?string $exemptionReasonCode = null): self
    {
        $positionagreement = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeAgreement');
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionQuantity(float $billedQuantity, string $billedQuantityUnitCode, ?float $chargeFreeQuantity = null, ?string $chargeFreeQuantityUnitCpde = null, ?float $packageQuantity = null, ?string $packageQuantityUnitCode = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionShipTo(?string $name = null, ?string $id = null, ?string $description = null): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
        $shipToTradeParty = $this->getObjectHelper()->getTradePartyAllowEmpty($name, $id, $description);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPositionShipToGlobalId(?string $globalID = null, ?string $globalIDType = null): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPositionShipToTaxRegistration(?string $taxRegType = null, ?string $taxRegId = null): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
        $shipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($positiondelivery, 'getShipToTradeParty');
        $taxReg = $this->getObjectHelper()->getTaxRegistrationType($taxRegType, $taxRegId);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionShipToAddress(?string $lineOne = null, ?string $lineTwo = null, ?string $lineThree = null, ?string $postCode = null, ?string $city = null, ?string $country = null, ?string $subDivision = null): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
        $shipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($positiondelivery, 'getShipToTradeParty');
        $address = $this->getObjectHelper()->getTradeAddress($lineOne, $lineTwo, $lineThree, $postCode, $city, $country, $subDivision);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionShipToLegalOrganisation(?string $legalOrgId, ?string $legalOrgType, ?string $legalOrgName): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
        $shipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($positiondelivery, 'getShipToTradeParty');
        $legalOrg = $this->getObjectHelper()->getLegalOrganization($legalOrgId, $legalOrgType, $legalOrgName);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionShipToContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
        $shipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($positiondelivery, 'getShipToTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPositionShipToContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
        $shipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($positiondelivery, 'getShipToTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionUltimateShipTo(?string $name = null, ?string $id = null, ?string $description = null): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
        $shipToTradeParty = $this->getObjectHelper()->getTradePartyAllowEmpty($name, $id, $description);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPositionUltimateShipToGlobalId(?string $globalID = null, ?string $globalIDType = null): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPositionUltimateShipToTaxRegistration(?string $taxRegType = null, ?string $taxRegId = null): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
        $ultimateShipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($positiondelivery, 'getUltimateShipToTradeParty');
        $taxReg = $this->getObjectHelper()->getTaxRegistrationType($taxRegType, $taxRegId);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionUltimateShipToAddress(?string $lineOne = null, ?string $lineTwo = null, ?string $lineThree = null, ?string $postCode = null, ?string $city = null, ?string $country = null, ?string $subDivision = null): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
        $ultimateShipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($positiondelivery, 'getUltimateShipToTradeParty');
        $address = $this->getObjectHelper()->getTradeAddress($lineOne, $lineTwo, $lineThree, $postCode, $city, $country, $subDivision);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionUltimateShipToLegalOrganisation(?string $legalOrgId, ?string $legalOrgType, ?string $legalOrgName): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
        $ultimateShipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($positiondelivery, 'getUltimateShipToTradeParty');
        $legalOrg = $this->getObjectHelper()->getLegalOrganization($legalOrgId, $legalOrgType, $legalOrgName);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionUltimateShipToContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
        $ultimateShipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($positiondelivery, 'getUltimateShipToTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPositionUltimateShipToContact(?string $contactPersonName, ?string $contactDepartmentName, ?string $contactPhoneNo, ?string $contactFaxNo, ?string $contactEmailAddress): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
        $ultimateShipToTradeParty = $this->getObjectHelper()->tryCallAndReturn($positiondelivery, 'getUltimateShipToTradeParty');
        $contact = $this->getObjectHelper()->getTradeContact($contactPersonName, $contactDepartmentName, $contactPhoneNo, $contactFaxNo, $contactEmailAddress);
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionSupplyChainEvent(?DateTimeInterface $date): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
        $supplyChainevent = $this->getObjectHelper()->getSupplyChainEventType($date);
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function setDocumentPositionDespatchAdviceReferencedDocument(string $issuerAssignedId, ?string $lineId = null, ?DateTimeInterface $issueDate = null): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function setDocumentPositionReceivingAdviceReferencedDocument(string $issuerAssignedId, ?string $lineId = null, ?DateTimeInterface $issueDate = null): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function setDocumentPositionDeliveryNoteReferencedDocument(string $issuerAssignedId, ?string $lineId = null, ?DateTimeInterface $issueDate = null): self
    {
        $positiondelivery = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeDelivery');
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPositionTax(string $categoryCode, string $typeCode, ?float $rateApplicablePercent, ?float $calculatedAmount = null, ?string $exemptionReason = null, ?string $exemptionReasonCode = null): self
    {
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionBillingPeriod(?DateTimeInterface $startDate, ?DateTimeInterface $endDate): self
    {
        $positionsettlement = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeSettlement');
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPositionAllowanceCharge(float $actualAmount, bool $isCharge, ?float $calculationPercent = null, ?float $basisAmount = null, ?string $reasonCode = null, ?string $reason = null): self
    {
        $positionsettlement = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeSettlement');
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionLineSummation(float $lineTotalAmount): self
    {
        $positionsettlement = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeSettlement');
     ...
     * @return ZugferdDocumentBuilder
     */
    public function setDocumentPositionLineSummationExt(float $lineTotalAmount, ?float $chargeTotalAmount = null, ?float $allowanceTotalAmount = null, ?float $taxTotalAmount = null, ?float $grandTotalAmount = null, ?float $totalAllowanceChargeAmount = null): self
    {
        $positionsettlement = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeSettlement');
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function addDocumentPositionInvoiceReferencedDocument(string $issuerAssignedId, string $lineid, ?string $typeCode = null, ?DateTimeInterface $issueDate = null): self
    {
        $positionsettlement = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeSettlement');
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function addDocumentPositionAdditionalReferencedDocumentObj(string $issuerAssignedId, string $typeCode, ?string $refTypeCode = null): self
    {
     ...
     * @throws ZugferdUnsupportedMimetype
     */
    public function addDocumentPositionAdditionalReferencedObjDocument(string $issuerAssignedId, string $typeCode, ?string $refTypeCode = null): self
    {
        $positionsettlement = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeSettlement');
     ...
     * @return ZugferdDocumentBuilder
     */
    public function addDocumentPositionReceivableSpecifiedTradeAccountingAccount(string $id, ?string $typeCode = null): self
    {
        $positionsettlement = $this->getObjectHelper()->tryCallAndReturn($this->currentPosition, 'getSpecifiedLineTradeSettlement');
        $account = $this->getObjectHelper()->getTradeAccountingAccountType($id, $typeCode);
