...
class ReaderBasicTest extends TestCase
{
    ...
    public function testDocumentGetters(): void
    {
        ...
        $this->assertEquals('horstoeko\zugferd\entities\basic\rsm\CrossIndustryInvoice', get_class($this->invokePrivateMethodFromObject(self::$document, 'getInvoiceObject')));
